...
public class GameState
{
    ...
    {
        var tavern = new Room { Name = "Tavern", Description = "You are in a cozy tavern with a friendly atmosphere." };
        var dungeon = new Room { Name = "Dungeon", Description = "You are in a dark and dank dungeon." };
